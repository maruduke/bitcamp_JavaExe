package collection02.Linkedlist02;
...
public class EmployeeManager {
	...
	// Employee의 자식객체들을 저장
	private List<Employee> empArr = new LinkedList<>();
	...
	private Employee findEmployee(String empNo) {
		return empArr.stream().filter(emp -> emp.empno.equals(empNo)).findFirst().orElseGet(null);
	}
