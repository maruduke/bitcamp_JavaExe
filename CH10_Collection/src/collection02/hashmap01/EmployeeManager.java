package collection02.hashmap01;
...
public class EmployeeManager {
	...
	private void removeEmployee(String empNo) {
		empArr.remove(empNo);
	}
	
	private void updateEmployee(Employee emp) {
		empArr.replace(emp.empno, emp);
	}
	
	private Employee findEmployee(String empNo) {
		return empArr.get(empNo);
	}
	
	private void viewAllEmployeeInfo() {
		for(int i=0;i<this.numOfEmp;i++) {
			this.empArr.forEach((key, value) -> {
