...
import ProblemClass4.Song;
import problemClass1.FruitBuyer;
import problemClass1.FruitSeller;
...
public static void answer4(Scanner sc) {
	Song song = new Song();
	song.setSongInfo("Dancing Queen", "artist", "album", "composer", "2024-01-31", 0);
	song.show();
}
