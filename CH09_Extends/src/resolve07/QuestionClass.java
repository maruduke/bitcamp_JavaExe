...
import Pb1.Sub;
import pb2.Triangle;
import pb3.ArrayUtility;
import pb4.ArrayUtility2;
import pb5.Child;
...
public static void answer2(Scanner sc) {
	...
	System.out.println("삼각형 넓이: " + tr.dimention());
}
...
public static void answer3(Scanner sc) {
	...
	double[] tmp1 = au.intToDouble(new int[] {1,2,3,});
	int[] tmp2 = au.doubleToInt(new double[] {1.5,2.1,3.0});
...
public static void answer4(Scanner sc) {
	...
	int [] ans1 = au.concat(tmp1, tmp2);
	int [] ans2 = au.remove(tmp1, tmp2);
